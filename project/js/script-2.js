                        ...
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body">
                                <div class="title mb-4 d-flex justify-content-between align-items-center">
                                    ...
                                    <p class="price d-flex"><span class="me-1">EGP</span><span>${product.discount[0]}</span></p>
                                </div>
                                <div class="buttons d-flex justify-content-start align-items-center">
                                    <button type="button"  id="btn-details" data-id="${product.id}" class="btn btn-primary buttonStyle me-3"
                                        data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom" aria-controls="offcanvasBottom">
                                                                                            Details
                                    </button>
                                    <button type="button" id="addCard" data-id="${product.id}" class="btn  btn-primary buttonStyle">Add to
                                                            Card
                                    </button>
                                </div>
                            </div>
        ...
        if (+product.id === buttonId) {
            ...
            detailsContainer.innerHTML += `
                    ...
                    <div class="form">
                        ...
                        <span>color:</span>
                        <span id="chooseColor">${product.color === true ? product.colorTypes[0] : "white" }</span>
                        </div>
                        ${product.color === true ? 
                        `<ul class="mt-2 colors d-flex align-items-center">
                        ${product.colorTypes.map((colorType, index) => ` <li ${index === 0 ? `class="active"`:""} id="${colorType}"></li>
                                        `).join(" ")}
                        </ul>`   
                        : ""}
                    </div>
